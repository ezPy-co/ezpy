...
class DownloadFileFormationTest(TestCase):
    ...
    def test_choice_presence_set1(self):
        ...
        self.assertIn('# Edit .bashrc profile', response.content)
        ...
        self.assertNotIn('# Pip install', response.content)
    ...
    def test_choice_presence_set2(self):
        ...
        self.assertIn('# Pip install', response.content)

        self.assertNotIn('# Download and run', response.content)
        self.assertNotIn('# Edit file', response.content)
        self.assertNotIn('# Edit .bashrc profile', response.content)
